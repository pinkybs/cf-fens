...
Ajax.Request = Class.create(Ajax.Base, {
  ...
  request: function(url) {
  	// #002 (2) start ==========================================================================================
  	// if timeout set, set timeout timer
  ...
  // #002 (3) start =============================
  // if time is out, call this mothed
  // and if set onTimeout, call it
  ...
  setRequestHeaders: function() {
    ...
    // #003 start =======================================
    // this is lack, in Firefox or Netscape will not work
