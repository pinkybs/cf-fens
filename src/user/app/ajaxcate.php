...
if (empty($keyword) && empty($hidSrhCate)) {
	echo 'none';
	exit(0);
}
...
//get search result
//else {
	$aryList = $dalPage->getPageListByKeywordAndFilter($pageIndex, $pageSize, $keyword, $hidSrhCate, 0);
//}
$count = (int)$dalPage->getPageListCountByKeywordAndFilter($keyword, $hidSrhCate, 0);
