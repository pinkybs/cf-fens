...
baseDialog.prototype = {
    ...
    setupDialog : function() {
        ...
        $('fullOverlay').innerHTML = '<div id="overlay"><iframe style="width:0px;height:0px;"></iframe></div><div id="overWindow"></div>';
...
function removeDialog() 
{
    ...
    //if IE,show all selectbox
    if (Prototype.Browser.IE && this.allSelect != null) {
       this.allSelect.each(Element.show);
    }  
}
...
function modifyDialogHeight()
{	
	var h = document.body.clientHeight;
    var height = $('overWindow').getHeight();
    $('overWindow').setStyle({ top: '100px'});
    //parent.parent.location.href = 'http://platform001.mixi.jp/run_appli.pl?id=507#app_content_507';
