...
$writer1 = new MyLib_Zend_Log_Writer_Stream(LOG_DIR . '/fensadmin-error.log');
$logger1 = new Zend_Log($writer1);

$writer2 = new MyLib_Zend_Log_Writer_Stream(LOG_DIR . '/fensadmin-debug.log');
...
$config = Bll_Config::get(CONFIG_DIR . '/fensadmin-config.xml');
