...
#ifndef __FENS_DEBUG_H__
#define __FENS_DEBUG_H__
...
extern uint answers[FENS_NB_ANSWERS];
...
#ifdef FENS_OPT_CRASH
#define crash(s) (cerr << s << "\n")
#else // FENS_OPT_CRASH
#define crash(s) ((void) 0)
#endif // FENS_OPT_CRASH
#endif // __FENS_DEBUG_H__
