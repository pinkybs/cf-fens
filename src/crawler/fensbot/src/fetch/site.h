...
#ifndef __FENS_SITE_H_
#define __FENS_SITE_H_
...
enum ConnState
{
    emptyC, connectingC, writeC, openC
};

// different state of dnsQuery
enum DnsState
{
    waitDns, doneDns, errorDns, noConnDns
};
