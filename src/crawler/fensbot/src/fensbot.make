...
LIBS:= -lmysqlclient -L/usr/local/mysql/lib/mysql -lhtmlcxx -L/usr/local/htmlcxx/lib
...
ABS-UTILS-OBJ:=utils/string.o utils/debug.o utils/url.o \
    ...
    utils/mypthread.o utils/CMysql.o utils/SiteDB.o \
    utils/EncodingConverter.o utils/compress.o
...
CXXFLAGS:= -Wno-deprecated -Wall -O3 -D_REENTRANT -I- -I$(BASEDIR) -I$(ADNSDIR) \
           -I/usr/local/mysql/include/mysql -I/usr/local/htmlcxx/include/htmlcxx/html
